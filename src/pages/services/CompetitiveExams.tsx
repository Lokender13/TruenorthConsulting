...
const CompetitiveExams = () => {
    ...
    return (
        <ServicePageLayout serviceId="competitive-exams">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 md:-mt-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
                    {[
                        { icon: Zap, title: "Speed Drills", desc: "Master time-saving hacks for IELTS, SAT, & GRE success." },
                        { icon: Award, title: "Band 8+ Expertise", desc: "Proven templates to conquer Writing & Speaking sections." },
                        { icon: TrendingUp, title: "Score Prediction", desc: "AI-driven mock analysis to predict your final test performance." }
                    ].map((item, i) => (
                        <motion.div
                            key={i}
