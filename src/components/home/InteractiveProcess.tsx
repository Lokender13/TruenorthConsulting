...
const steps = [
    {
        ...
        description: "We begin by understanding your unique strengths, interests, and aspirations through specialized psychometric assessments.",
        color: "orange",
...
const InteractiveProcess: React.FC = () => {
    ...
    return (
        <section ref={containerRef} className={`py-32 relative overflow-hidden theme-transition ${isDark ? 'bg-zinc-950/0' : 'bg-transparent'}`}>
            {/* Background elements */}
