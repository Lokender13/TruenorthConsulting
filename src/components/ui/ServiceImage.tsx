...
const serviceImages: Record<string, { src: string; alt: string }> = {
    'career-counselling': {
        ...
        alt: 'Strategic career planning session'
    },
    'study-abroad': {
    ...
    'academic-support': {
        ...
        alt: 'Focused student receiving one-on-one guidance from a tutor'
    },
    'competitive-exams': {
    ...
    'career-lab': {
        ...
        alt: 'Students collaborating in a modern innovation lab'
    },
    'digital-solutions': {
